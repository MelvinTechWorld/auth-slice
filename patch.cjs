...
const replacement1 = `**Prerequisites**
...
const target2 = `### Step 1 — [what the user does]
...
const replacement2 = `### Step 1 — Account Creation
...
// Replace exactly by splitting and joining
